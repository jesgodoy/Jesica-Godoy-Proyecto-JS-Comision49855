...
alert ("Hola "+saludo+" estoy aui para ayudarte a realizar tu compra")
...
do{
    ...
    var userInput = prompt("Ingrese algo (presione Cancelar para detener)");
